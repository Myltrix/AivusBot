...
Here is the cleaned and fully rewritten README **in English**, with instructions on how to add the **Telegram Bot Token** and **Gemini API Key**, and with all website-related content removed.
