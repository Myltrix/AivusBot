<table>
  <tr>
    ...
    <td style="padding-left: 30px;">
      <h1 style="color: #2a7de1; margin-top: 0;">AIBot</h1>
      <p style="font-size: 16px; line-height: 1.6; color: #333;">
        A simple Telegram bot for chatting with AI using the Google Gemini API. You can use it as a personal assistant to get answers, generate text, help with learning, or just have interesting conversations.
      </p>
